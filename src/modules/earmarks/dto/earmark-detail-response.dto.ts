...
export class EarmarkDetailResponseDto {
  @ApiProperty({
    description: 'Unique identifier of the earmark detail',
  ...
  @ApiProperty({
    description: 'Timestamp when the earmark detail was created',
    example: '2026-01-30T00:00:00.000Z',
  })
  created_at: Date;

  @ApiProperty({
    description: 'Timestamp when the earmark detail was last updated',
    example: '2026-01-30T00:00:00.000Z',
  })
  updated_at: Date;
}
